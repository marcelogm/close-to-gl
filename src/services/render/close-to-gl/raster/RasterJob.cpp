...
vector<unsigned char> close::RasterJob::apply(size_t count) {
...
void RasterJob::draw(RgbBuffer* buffer, float* zBuffer, data::VertexPayload* v0, data::VertexPayload* v1, data::VertexPayload* v2) {
	this->floor(v0); 
	this->floor(v1); 
	this->floor(v2);
